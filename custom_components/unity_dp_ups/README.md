...
5. Add `https://github.com/yourusername/homeassistant-unity-dp` as an integration
6. Click "Install"
...
For issues, please open an issue on [GitHub](https://github.com/yourusername/homeassistant-unity-dp/issues).
